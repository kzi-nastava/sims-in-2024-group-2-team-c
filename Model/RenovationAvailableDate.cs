...
namespace BookingApp.Model
{
    public class RenovationAvailableDate : ISerializable
    {
        ...
        public string[] ToCSV()
        {
            string[] csvValues = { Id.ToString(), Accommodation.Name/*,StartDate.ToString(), EndDate.ToString()*/,StartDate.ToString("dd.MM.yyyy. HH:mm:ss"),EndDate.ToString("dd.MM.yyyy. HH:mm:ss"), Description };
            return csvValues;
        }
    }
}
